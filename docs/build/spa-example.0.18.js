							...
							_1: {
								...
								_1: {
									...
									_0: A2(
										_user$project$Util_ops['=>'],
										'updatedAt',
										_elm_lang$core$Json_Encode$string(user.updatedAt)),
									_1: {ctor: '[]'}
								}
							}
						}
			...
			return {
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							linkTo,
							_user$project$Route$Profile(_p2.username),
							{
								ctor: '::',
								_0: A2(
									_elm_lang$html$Html$img,
									{
										...
										_1: {
											ctor: '::',
											_0: _user$project$Data_UserPhoto$src(_p2.image),
											_1: {ctor: '[]'}
										}
									},
									{ctor: '[]'}),
								_1: {
									ctor: '::',
									_0: _user$project$Data_User$usernameToHtml(_p2.username),
									_1: {ctor: '[]'}
								}
							}),
						_1: {
...
var _user$project$Page_Article_Editor$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {errors: a, editingArticle: b, title: c, body: d, description: e, tags: f, isSaving: g};
	});
								...
								_1: {
									...
									_0: A2(
										_elm_lang$html$Html$button,
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$disabled(model.isSaving),
												_1: {ctor: '[]'}
											}
										},
										{
...
var _user$project$Page_Article_Editor$modelValidator = _rtfeldman$elm_validate$Validate$all(
	{
		ctor: '::',
		_0: A2(
...
var _user$project$Page_Article_Editor$update = F3(
	function (user, msg, model) {
		...
		switch (_p3.ctor) {
			case 'Save':
				var _p4 = A2(_rtfeldman$elm_validate$Validate$validate, _user$project$Page_Article_Editor$modelValidator, model);
				if (_p4.ctor === '[]') {
					...
					if (_p5.ctor === 'Nothing') {
						...
						return A2(
							...
							A2(
								...
								A3(_user$project$Request_Article$update, _p5._0, model, user.token)));
					}
				} else {
					return A2(
						_user$project$Util_ops['=>'],
			...
			case 'SetTags':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							tags: _user$project$Page_Article_Editor$tagsFromString(_p3._0)
						}),
					_elm_lang$core$Platform_Cmd$none);
			case 'SetBody':
				return A2(
				...
				if (_p3._0.ctor === 'Ok') {
					return A2(
						...
						_user$project$Route$modifyUrl(
							_user$project$Route$Article(_p3._0._0.slug)));
				} else {
					return A2(
						_user$project$Util_ops['=>'],
						_elm_lang$core$Native_Utils.update(
...
var _user$project$Page_Login$modelValidator = _rtfeldman$elm_validate$Validate$all(
	{
		ctor: '::',
		_0: A2(
			_rtfeldman$elm_validate$Validate$ifBlank,
...
var _user$project$Page_Login$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'SubmitForm':
				var _p1 = A2(_rtfeldman$elm_validate$Validate$validate, _user$project$Page_Login$modelValidator, model);
				if (_p1.ctor === '[]') {
					return A2(
						_user$project$Util_ops['=>'],
						A2(
					...
					return A2(
						...
						A2(
							...
							_elm_lang$core$Platform_Cmd$batch(
								{
									ctor: '::',
									_0: _user$project$Request_User$storeSession(_p3),
									_1: {
										ctor: '::',
						...
						_user$project$Page_Login$SetUser(_p3));
				}
		}
	});
...
var _user$project$Page_Register$modelValidator = _rtfeldman$elm_validate$Validate$all(
	{
		ctor: '::',
		_0: A2(
			_rtfeldman$elm_validate$Validate$ifBlank,
...
var _user$project$Page_Register$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'SubmitForm':
				var _p1 = A2(_rtfeldman$elm_validate$Validate$validate, _user$project$Page_Register$modelValidator, model);
				if (_p1.ctor === '[]') {
					return A2(
						_user$project$Util_ops['=>'],
						A2(
			...
			default:
				if (_p0._0.ctor === 'Err') {
					...
					return A2(
						...
						_user$project$Page_Register$SetUser(_p3));
				}
		}
	});
...
var _user$project$Page_Settings$modelValidator = _rtfeldman$elm_validate$Validate$all(
	{
		ctor: '::',
		_0: A2(
			_rtfeldman$elm_validate$Validate$ifBlank,
...
var _user$project$Page_Settings$update = F3(
	function (session, msg, model) {
		...
		switch (_p0.ctor) {
			case 'SubmitForm':
				var _p1 = A2(_rtfeldman$elm_validate$Validate$validate, _user$project$Page_Settings$modelValidator, model);
				if (_p1.ctor === '[]') {
					return A2(
						_user$project$Util_ops['=>'],
						A2(
			...
			case 'SetPassword':
				var _p2 = _p0._0;
				var password = _elm_lang$core$String$isEmpty(_p2) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(_p2);
				return A2(
					_user$project$Util_ops['=>'],
					A2(
						_user$project$Util_ops['=>'],
			...
			case 'SetImage':
				var _p3 = _p0._0;
				var image = _elm_lang$core$String$isEmpty(_p3) ? _elm_lang$core$Maybe$Nothing : _elm_lang$core$Maybe$Just(_p3);
				return A2(
					_user$project$Util_ops['=>'],
					A2(
						_user$project$Util_ops['=>'],
			...
			default:
				if (_p0._0.ctor === 'Err') {
					...
					return A2(
						...
						_user$project$Page_Settings$SetUser(_p5));
				}
		}
	});
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Data.Article.Body":{"args":[],"tags":{"Body":["Data.Article.Markdown"]}},"Data.Article.Comment.CommentId":{"args":[],"tags":{"CommentId":["Int"]}},"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Data.User.Username":{"args":[],"tags":{"Username":["String"]}},"Views.Article.Feed.Msg":{"args":[],"tags":{"SelectFeedSource":["Views.Article.Feed.FeedSource"],"ToggleFavorite":["Data.Article.Article ()"],"FavoriteCompleted":["Result.Result Http.Error (Data.Article.Article ())"],"FeedLoadCompleted":["Views.Article.Feed.FeedSource","Result.Result Http.Error ( Int, Data.Article.Feed.Feed )"],"DismissErrors":[],"SelectPage":["Int"]}},"Data.AuthToken.AuthToken":{"args":[],"tags":{"AuthToken":["String"]}},"Data.UserPhoto.UserPhoto":{"args":[],"tags":{"UserPhoto":["Maybe.Maybe String"]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"SelectList.SelectList":{"args":["a"],"tags":{"SelectList":["List a","a","List a"]}},"Date.Date":{"args":[],"tags":{"Date":[]}},"Route.Route":{"args":[],"tags":{"Article":["Data.Article.Slug"],"Home":[],"Logout":[],"Settings":[],"EditArticle":["Data.Article.Slug"],"Profile":["Data.User.Username"],"Root":[],"Register":[],"NewArticle":[],"Login":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Page.Profile.Msg":{"args":[],"tags":{"FeedMsg":["Views.Article.Feed.Msg"],"DismissErrors":[],"FollowCompleted":["Result.Result Http.Error Data.Profile.Profile"],"ToggleFollow":[]}},"Data.Article.Slug":{"args":[],"tags":{"Slug":["String"]}},"Main.Msg":{"args":[],"tags":{"ProfileLoaded":["Data.User.Username","Result.Result Page.Errored.PageLoadError Page.Profile.Model"],"EditArticleLoaded":["Data.Article.Slug","Result.Result Page.Errored.PageLoadError Page.Article.Editor.Model"],"LoginMsg":["Page.Login.Msg"],"ArticleMsg":["Page.Article.Msg"],"EditorMsg":["Page.Article.Editor.Msg"],"HomeLoaded":["Result.Result Page.Errored.PageLoadError Page.Home.Model"],"SetUser":["Maybe.Maybe Data.User.User"],"SetRoute":["Maybe.Maybe Route.Route"],"ArticleLoaded":["Result.Result Page.Errored.PageLoadError Page.Article.Model"],"HomeMsg":["Page.Home.Msg"],"SettingsMsg":["Page.Settings.Msg"],"ProfileMsg":["Page.Profile.Msg"],"RegisterMsg":["Page.Register.Msg"]}},"Page.Errored.PageLoadError":{"args":[],"tags":{"PageLoadError":["Page.Errored.Model"]}},"Page.Settings.Msg":{"args":[],"tags":{"SetImage":["String"],"SetUsername":["String"],"SaveCompleted":["Result.Result Http.Error Data.User.User"],"SubmitForm":[],"SetPassword":["String"],"SetBio":["String"],"SetEmail":["String"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Page.Article.Editor.Field":{"args":[],"tags":{"Body":[],"Title":[],"Form":[]}},"Views.Page.ActivePage":{"args":[],"tags":{"Other":[],"Home":[],"Settings":[],"Profile":["Data.User.Username"],"Register":[],"NewArticle":[],"Login":[]}},"Page.Home.Msg":{"args":[],"tags":{"FeedMsg":["Views.Article.Feed.Msg"],"SelectTag":["Data.Article.Tag"]}},"Page.Register.Msg":{"args":[],"tags":{"RegisterCompleted":["Result.Result Http.Error Data.User.User"],"SetUsername":["String"],"SubmitForm":[],"SetPassword":["String"],"SetEmail":["String"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Data.Article.Tag":{"args":[],"tags":{"Tag":["String"]}},"Page.Article.Msg":{"args":[],"tags":{"CommentPosted":["Result.Result Http.Error Data.Article.Comment.Comment"],"DeleteArticle":[],"ToggleFavorite":[],"CommentDeleted":["Data.Article.Comment.CommentId","Result.Result Http.Error ()"],"FavoriteCompleted":["Result.Result Http.Error (Data.Article.Article Data.Article.Body)"],"DismissErrors":[],"FollowCompleted":["Result.Result Http.Error Data.Article.Author.Author"],"SetCommentText":["String"],"DeleteComment":["Data.Article.Comment.CommentId"],"PostComment":[],"ToggleFollow":[],"ArticleDeleted":["Result.Result Http.Error ()"]}},"Views.Article.Feed.Model":{"args":[],"tags":{"Model":["Views.Article.Feed.InternalModel"]}},"Page.Login.Msg":{"args":[],"tags":{"LoginCompleted":["Result.Result Http.Error Data.User.User"],"SubmitForm":[],"SetPassword":["String"],"SetEmail":["String"]}},"Views.Article.Feed.FeedSource":{"args":[],"tags":{"FavoritedFeed":["Data.User.Username"],"TagFeed":["Data.Article.Tag"],"YourFeed":[],"AuthorFeed":["Data.User.Username"],"GlobalFeed":[]}},"Page.Article.Editor.Msg":{"args":[],"tags":{"SetDescription":["String"],"SetBody":["String"],"CreateCompleted":["Result.Result Http.Error (Data.Article.Article Data.Article.Body)"],"SetTitle":["String"],"SetTags":["String"],"EditCompleted":["Result.Result Http.Error (Data.Article.Article Data.Article.Body)"],"Save":[]}}},"aliases":{"Page.Article.Editor.Model":{"args":[],"type":"{ errors : List Page.Article.Editor.Error , editingArticle : Maybe.Maybe Data.Article.Slug , title : String , body : String , description : String , tags : List String , isSaving : Bool }"},"Data.Article.Author.Author":{"args":[],"type":"{ username : Data.User.Username , bio : Maybe.Maybe String , image : Data.UserPhoto.UserPhoto , following : Bool }"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Page.Errored.Model":{"args":[],"type":"{ activePage : Views.Page.ActivePage, errorMessage : String }"},"Data.Article.Article":{"args":["a"],"type":"{ description : String , slug : Data.Article.Slug , title : String , tags : List String , createdAt : Date.Date , updatedAt : Date.Date , favorited : Bool , favoritesCount : Int , author : Data.Article.Author.Author , body : a }"},"Data.Profile.Profile":{"args":[],"type":"{ username : Data.User.Username , bio : Maybe.Maybe String , image : Data.UserPhoto.UserPhoto , following : Bool }"},"Page.Home.Model":{"args":[],"type":"{ tags : List Data.Article.Tag, feed : Views.Article.Feed.Model }"},"Data.Article.Markdown":{"args":[],"type":"String"},"Page.Profile.Model":{"args":[],"type":"{ errors : List String , profile : Data.Profile.Profile , feed : Views.Article.Feed.Model }"},"Data.Article.Comment.Comment":{"args":[],"type":"{ id : Data.Article.Comment.CommentId , body : String , createdAt : Date.Date , updatedAt : Date.Date , author : Data.Article.Author.Author }"},"Data.Article.Feed.Feed":{"args":[],"type":"{ articles : List (Data.Article.Article ()), articlesCount : Int }"},"Data.User.User":{"args":[],"type":"{ email : String , token : Data.AuthToken.AuthToken , username : Data.User.Username , bio : Maybe.Maybe String , image : Data.UserPhoto.UserPhoto , createdAt : String , updatedAt : String }"},"Page.Article.Editor.Error":{"args":[],"type":"( Page.Article.Editor.Field, String )"},"Page.Article.Model":{"args":[],"type":"{ errors : List String , commentText : String , commentInFlight : Bool , article : Data.Article.Article Data.Article.Body , comments : List Data.Article.Comment.Comment }"},"Views.Article.Feed.InternalModel":{"args":[],"type":"{ errors : List String , feed : Data.Article.Feed.Feed , feedSources : SelectList.SelectList Views.Article.Feed.FeedSource , activePage : Int , isLoading : Bool }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
