...
var author$project$Main$maybeMyUrl = elm_lang$url$Url$Parser$toUrl('http://example.com/a/b/c/#a/b/c');
var author$project$Main$Docs = F5(
	function (name1, name2, name3, value1, value2) {
		return {name1: name1, name2: name2, name3: name3, value1: value1, value2: value2};
	});
...
var author$project$Main$threeLevels = A2(
...
var author$project$Main$parse1 = elm_lang$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			A2(
				elm_lang$url$Url$Parser$slash,
				author$project$Main$threeLevels,
				A2(
					elm_lang$url$Url$Parser$slash,
					elm_lang$url$Url$Parser$fragment(
						function (a) {
							return a;
						}),
...
var author$project$Main$parse2 = elm_lang$url$Url$Parser$oneOf(
	_List_fromArray(
		[
			...
			A2(elm_lang$url$Url$Parser$map, author$project$Main$ThreeLevels, author$project$Main$threeLevels)
		]));
...
var author$project$Main$main = elm_lang$browser$Browser$staticPage(
	function () {
		var _n0 = author$project$Main$maybeMyUrl;
		if (_n0.$ === 'Nothing') {
